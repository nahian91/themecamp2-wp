               ...
               <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6">
                     <div class="about-item-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/home-7.jpg" alt="" class="img-fluid">
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="container">
               ...
               <div class="row justify-content-center">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="team-item-wrap mb-5 mb-lg-0">
                        <div class="team-item position-relative">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-6.jpg" alt="" class="img-fluid w-100">
                        </div>
                        <div class="team-item-content">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="team-item-wrap mb-5 mb-lg-0 ">
                        <div class="team-item position-relative">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/team-5.jpg" alt="" class="img-fluid w-100">
                        </div>
                        <div class="team-item-content">
